...
from src.database import init_db, save_forecasts
...
def fetch_cwa_data(api_key: str | None = None) -> dict:
    """Fetch 1-week weather forecast JSON from CWA Open Data API."""
    load_dotenv()
    if api_key is None:
...
def parse_forecast_data(data: dict) -> pd.DataFrame:
    """Parse CWA JSON into clean Pandas DataFrame."""
    # ==========================================
